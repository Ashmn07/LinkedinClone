        ...
        <div className="space-y-2 min-w-max max-w-lg">
            ...
            flex flex-col items-center text-center border border-gray-300 dark:border-none">
                ...
                <Avatar
                    ...
                    //src="https://img.favpng.com/11/21/25/iron-man-cartoon-avatar-superhero-icon-png-favpng-jrRBMJQjeUwuteGtBce87yMxz.jpg"
                    className="!h-14 !w-14 !border-2 !absolute !top-4 !cursor-pointer"
                />
                <div className="mt-5 py-4 space-x-0.5">
                    <h4 className="hover:underline decoration-purple-700 
